          ...
          <CCard class="mx-4">
            <CCardBody class="p-4">
              <CForm>
                ...
                <CCol>
                <button @click="userUpdate" color="primary" class="px-4">UPDATE PROFILE</button>
                </CCol>
              </CForm>
            </CCardBody>
          </CCard>
  ...
  methods: {
    userUpdate(){
      ...
      if(this.userData.userpassword===this.userData.confirmpassword){
        this.$appAxios
      .put(`/User/`+2, {userId:2,userType:userData.usertype, userFirstName:this.userData.userfname,
      userLastName:this.userData.userlname, userPhone:this.userData.userphone,userEmail:this.userData.useremail,
